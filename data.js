...
var plink1 = [
  ...
  { hero: 'Ieyasu', pokes: ['Aron', 'Lairon', 'Aggron', 'Registeel'] },
  { hero: 'Ieyasu', pokes: ['Registeel'] },
  ...
  { hero: 'Nobunaga', pokes: ['Deino', 'Zweilous', 'Hydreigon'] },
  { hero: 'Nobunaga', pokes: ['Zekrom', 'Rayquaza'] },
  { hero: 'Nō', pokes: ['Misdreavus', 'Mismagius'] },
  { hero: 'Okuni', pokes: ['Larvesta', 'Volcarona'] },
  { hero: 'Ranmaru', pokes: ['Riolu', 'Lucario'] },
  { hero: 'Shingen', pokes: ['Rhyhorn', 'Rhydon', 'Rhyperior'] },
  { hero: 'Shingen', pokes: ['Groudon'] },
